 ...
 * [nutrition.yml](nutrition.yml)
     * Determines how your purl.obolibrary.org/obo/nutrition/ redirects will be handled
     ...
     * Paste in the contents of [nutrition.yml](nutrition.yml)
 ...
 * [nutrition.md](nutrition.md)
     ...
     * Paste in the contents of [nutrition.md](nutrition.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
